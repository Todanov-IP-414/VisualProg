...
import { PI, createUser, createBook, calculateArea, getStatusColor, capitalFirst, probeloobrezat, getFirstElement, findById } from './main.ts';
describe('Константы', () => {
...
describe('getFirstElement', () => {
    ...
    it('должен возвращать undefined для undefined массива', () => {
        expect(getFirstElement(undefined)).toBeUndefined();
    });
...
describe('findById', () => {
    ...
    it('должен быть типобезопасным (возвращать правильный тип)', () => {
        ...
        expect(result === null || result === void 0 ? void 0 : result.customField).toBe('test');
    });
    it('должен корректно сравнивать числовые id', () => {
        ...
        expect((_a = findById(items, 1)) === null || _a === void 0 ? void 0 : _a.name).toBe('First');
        expect((_b = findById(items, 2)) === null || _b === void 0 ? void 0 : _b.name).toBe('Second');
    });
});
